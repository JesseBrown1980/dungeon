...
class Room(Label, GridWidget):
    ...
    def __init__(self, grid=None, direction=None, minSize=2, maxSize=10, **kwargs):
        super(Room, self).__init__(**kwargs)
        self.direction = (direction or randint(0,360))
        self.velocity = Vector(self.grid_unit,0).rotate(self.direction)
        self.size = (randint(minSize, maxSize) * self.grid_unit,
                     randint(minSize, maxSize) * self.grid_unit)
